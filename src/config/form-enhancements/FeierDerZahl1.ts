// Auto-generated. Per-entity form-enhancements config for "Feier der Zahl 1".
...
export const formEnhancements: FormEnhancements = {
  ...
  defaults: {
    'datum_feier': { kind: 'today', withTime: true },
    'teilnehmerzahl': { kind: 'literal', value: 1 },
    'anlass': { kind: 'lookup', key: 'erster_geburtstag', label: 'Erster Geburtstag' },
  },
  computed: {},
};
